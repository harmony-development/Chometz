...
namespace chat {
namespace v1 {
class GetUserBulkRequest;
class GetUserBulkRequestDefaultTypeInternal;
extern GetUserBulkRequestDefaultTypeInternal _GetUserBulkRequest_default_instance_;
class GetUserBulkResponse;
class GetUserBulkResponseDefaultTypeInternal;
extern GetUserBulkResponseDefaultTypeInternal _GetUserBulkResponse_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::protocol::chat::v1::GetUserBulkRequest* Arena::CreateMaybeMessage<::protocol::chat::v1::GetUserBulkRequest>(Arena*);
template<> ::protocol::chat::v1::GetUserBulkResponse* Arena::CreateMaybeMessage<::protocol::chat::v1::GetUserBulkResponse>(Arena*);
...
class GetUserBulkRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protocol.chat.v1.GetUserBulkRequest) */ {
 public:
  inline GetUserBulkRequest() : GetUserBulkRequest(nullptr) {};
  virtual ~GetUserBulkRequest();

  GetUserBulkRequest(const GetUserBulkRequest& from);
  GetUserBulkRequest(GetUserBulkRequest&& from) noexcept
    : GetUserBulkRequest() {
    *this = ::std::move(from);
  }

  inline GetUserBulkRequest& operator=(const GetUserBulkRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetUserBulkRequest& operator=(GetUserBulkRequest&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetUserBulkRequest& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetUserBulkRequest* internal_default_instance() {
    return reinterpret_cast<const GetUserBulkRequest*>(
               &_GetUserBulkRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(GetUserBulkRequest& a, GetUserBulkRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(GetUserBulkRequest* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(GetUserBulkRequest* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline GetUserBulkRequest* New() const final {
    return CreateMaybeMessage<GetUserBulkRequest>(nullptr);
  }

  GetUserBulkRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetUserBulkRequest>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetUserBulkRequest& from);
  void MergeFrom(const GetUserBulkRequest& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetUserBulkRequest* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "protocol.chat.v1.GetUserBulkRequest";
  }
  protected:
  explicit GetUserBulkRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  void clear_user_ids();
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_user_ids(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::uint64 >&
      _internal_user_ids() const;
  void _internal_add_user_ids(::PROTOBUF_NAMESPACE_ID::uint64 value);
  ...
  // @@protoc_insertion_point(class_scope:protocol.chat.v1.GetUserBulkRequest)
 private:
  class _Internal;
...
class GetUserBulkResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protocol.chat.v1.GetUserBulkResponse) */ {
 public:
  inline GetUserBulkResponse() : GetUserBulkResponse(nullptr) {};
  virtual ~GetUserBulkResponse();

  GetUserBulkResponse(const GetUserBulkResponse& from);
  GetUserBulkResponse(GetUserBulkResponse&& from) noexcept
    : GetUserBulkResponse() {
    *this = ::std::move(from);
  }

  inline GetUserBulkResponse& operator=(const GetUserBulkResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetUserBulkResponse& operator=(GetUserBulkResponse&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetUserBulkResponse& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetUserBulkResponse* internal_default_instance() {
    return reinterpret_cast<const GetUserBulkResponse*>(
               &_GetUserBulkResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(GetUserBulkResponse& a, GetUserBulkResponse& b) {
    a.Swap(&b);
  }
  inline void Swap(GetUserBulkResponse* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(GetUserBulkResponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline GetUserBulkResponse* New() const final {
    return CreateMaybeMessage<GetUserBulkResponse>(nullptr);
  }

  GetUserBulkResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetUserBulkResponse>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetUserBulkResponse& from);
  void MergeFrom(const GetUserBulkResponse& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetUserBulkResponse* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "protocol.chat.v1.GetUserBulkResponse";
  }
  protected:
  explicit GetUserBulkResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  public:
  void clear_users();
  ::protocol::chat::v1::GetUserResponse* mutable_users(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::protocol::chat::v1::GetUserResponse >*
      mutable_users();
  private:
  const ::protocol::chat::v1::GetUserResponse& _internal_users(int index) const;
  ::protocol::chat::v1::GetUserResponse* _internal_add_users();
  public:
  const ::protocol::chat::v1::GetUserResponse& users(int index) const;
  ::protocol::chat::v1::GetUserResponse* add_users();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::protocol::chat::v1::GetUserResponse >&
      users() const;

  // @@protoc_insertion_point(class_scope:protocol.chat.v1.GetUserBulkResponse)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::protocol::chat::v1::GetUserResponse > users_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_chat_2fv1_2fprofile_2eproto;
};
// -------------------------------------------------------------------
...
// repeated uint64 user_ids = 1;
inline int GetUserBulkRequest::_internal_user_ids_size() const {
  return user_ids_.size();
}
inline int GetUserBulkRequest::user_ids_size() const {
  return _internal_user_ids_size();
}
inline void GetUserBulkRequest::clear_user_ids() {
  user_ids_.Clear();
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 GetUserBulkRequest::_internal_user_ids(int index) const {
  return user_ids_.Get(index);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 GetUserBulkRequest::user_ids(int index) const {
  // @@protoc_insertion_point(field_get:protocol.chat.v1.GetUserBulkRequest.user_ids)
  return _internal_user_ids(index);
}
inline void GetUserBulkRequest::set_user_ids(int index, ::PROTOBUF_NAMESPACE_ID::uint64 value) {
  user_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:protocol.chat.v1.GetUserBulkRequest.user_ids)
}
inline void GetUserBulkRequest::_internal_add_user_ids(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  user_ids_.Add(value);
}
inline void GetUserBulkRequest::add_user_ids(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_add_user_ids(value);
  // @@protoc_insertion_point(field_add:protocol.chat.v1.GetUserBulkRequest.user_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::uint64 >&
GetUserBulkRequest::_internal_user_ids() const {
  return user_ids_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::uint64 >&
GetUserBulkRequest::user_ids() const {
  // @@protoc_insertion_point(field_list:protocol.chat.v1.GetUserBulkRequest.user_ids)
  return _internal_user_ids();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::uint64 >*
GetUserBulkRequest::_internal_mutable_user_ids() {
  return &user_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::uint64 >*
GetUserBulkRequest::mutable_user_ids() {
  // @@protoc_insertion_point(field_mutable_list:protocol.chat.v1.GetUserBulkRequest.user_ids)
...
// repeated .protocol.chat.v1.GetUserResponse users = 1;
inline int GetUserBulkResponse::_internal_users_size() const {
  return users_.size();
}
inline int GetUserBulkResponse::users_size() const {
  return _internal_users_size();
}
inline void GetUserBulkResponse::clear_users() {
  users_.Clear();
}
inline ::protocol::chat::v1::GetUserResponse* GetUserBulkResponse::mutable_users(int index) {
  // @@protoc_insertion_point(field_mutable:protocol.chat.v1.GetUserBulkResponse.users)
  return users_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::protocol::chat::v1::GetUserResponse >*
GetUserBulkResponse::mutable_users() {
  // @@protoc_insertion_point(field_mutable_list:protocol.chat.v1.GetUserBulkResponse.users)
  return &users_;
}
inline const ::protocol::chat::v1::GetUserResponse& GetUserBulkResponse::_internal_users(int index) const {
  return users_.Get(index);
}
inline const ::protocol::chat::v1::GetUserResponse& GetUserBulkResponse::users(int index) const {
  // @@protoc_insertion_point(field_get:protocol.chat.v1.GetUserBulkResponse.users)
  return _internal_users(index);
}
inline ::protocol::chat::v1::GetUserResponse* GetUserBulkResponse::_internal_add_users() {
  return users_.Add();
}
inline ::protocol::chat::v1::GetUserResponse* GetUserBulkResponse::add_users() {
  // @@protoc_insertion_point(field_add:protocol.chat.v1.GetUserBulkResponse.users)
  return _internal_add_users();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::protocol::chat::v1::GetUserResponse >&
GetUserBulkResponse::users() const {
  // @@protoc_insertion_point(field_list:protocol.chat.v1.GetUserBulkResponse.users)
  return users_;
}
