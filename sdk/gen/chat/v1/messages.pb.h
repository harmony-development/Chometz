...
class UpdateMessageTextRequest;
class UpdateMessageTextRequestDefaultTypeInternal;
extern UpdateMessageTextRequestDefaultTypeInternal _UpdateMessageTextRequest_default_instance_;
}  // namespace v1
}  // namespace chat
}  // namespace protocol
PROTOBUF_NAMESPACE_OPEN
...
template<> ::protocol::chat::v1::UpdateMessageTextRequest* Arena::CreateMaybeMessage<::protocol::chat::v1::UpdateMessageTextRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace protocol {
namespace chat {
namespace v1 {

enum GetChannelMessagesRequest_Direction : int {
  GetChannelMessagesRequest_Direction_before = 0,
  GetChannelMessagesRequest_Direction_around = 1,
  GetChannelMessagesRequest_Direction_after = 2,
  GetChannelMessagesRequest_Direction_GetChannelMessagesRequest_Direction_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  GetChannelMessagesRequest_Direction_GetChannelMessagesRequest_Direction_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool GetChannelMessagesRequest_Direction_IsValid(int value);
constexpr GetChannelMessagesRequest_Direction GetChannelMessagesRequest_Direction_Direction_MIN = GetChannelMessagesRequest_Direction_before;
constexpr GetChannelMessagesRequest_Direction GetChannelMessagesRequest_Direction_Direction_MAX = GetChannelMessagesRequest_Direction_after;
constexpr int GetChannelMessagesRequest_Direction_Direction_ARRAYSIZE = GetChannelMessagesRequest_Direction_Direction_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* GetChannelMessagesRequest_Direction_descriptor();
template<typename T>
inline const std::string& GetChannelMessagesRequest_Direction_Name(T enum_t_value) {
  static_assert(::std::is_same<T, GetChannelMessagesRequest_Direction>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function GetChannelMessagesRequest_Direction_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    GetChannelMessagesRequest_Direction_descriptor(), enum_t_value);
}
inline bool GetChannelMessagesRequest_Direction_Parse(
    const std::string& name, GetChannelMessagesRequest_Direction* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<GetChannelMessagesRequest_Direction>(
    GetChannelMessagesRequest_Direction_descriptor(), name, value);
}
// ===================================================================
...
class GetChannelMessagesRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  typedef GetChannelMessagesRequest_Direction Direction;
  static constexpr Direction before =
    GetChannelMessagesRequest_Direction_before;
  static constexpr Direction around =
    GetChannelMessagesRequest_Direction_around;
  static constexpr Direction after =
    GetChannelMessagesRequest_Direction_after;
  static inline bool Direction_IsValid(int value) {
    return GetChannelMessagesRequest_Direction_IsValid(value);
  }
  static constexpr Direction Direction_MIN =
    GetChannelMessagesRequest_Direction_Direction_MIN;
  static constexpr Direction Direction_MAX =
    GetChannelMessagesRequest_Direction_Direction_MAX;
  static constexpr int Direction_ARRAYSIZE =
    GetChannelMessagesRequest_Direction_Direction_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  Direction_descriptor() {
    return GetChannelMessagesRequest_Direction_descriptor();
  }
  template<typename T>
  static inline const std::string& Direction_Name(T enum_t_value) {
    ...
    return GetChannelMessagesRequest_Direction_Name(enum_t_value);
  }
  static inline bool Direction_Parse(const std::string& name,
      Direction* value) {
    return GetChannelMessagesRequest_Direction_Parse(name, value);
  }
  ...
  // .protocol.chat.v1.GetChannelMessagesRequest.Direction direction = 4;
  void clear_direction();
  ::protocol::chat::v1::GetChannelMessagesRequest_Direction direction() const;
  void set_direction(::protocol::chat::v1::GetChannelMessagesRequest_Direction value);
  private:
  ::protocol::chat::v1::GetChannelMessagesRequest_Direction _internal_direction() const;
  void _internal_set_direction(::protocol::chat::v1::GetChannelMessagesRequest_Direction value);
  public:
...
class SendMessageRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    ...
    kOverridesFieldNumber = 6,
    kGuildIdFieldNumber = 1,
    kChannelIdFieldNumber = 2,
    kEchoIdFieldNumber = 4,
...
class UpdateMessageTextRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protocol.chat.v1.UpdateMessageTextRequest) */ {
 public:
  inline UpdateMessageTextRequest() : UpdateMessageTextRequest(nullptr) {};
  virtual ~UpdateMessageTextRequest();

  UpdateMessageTextRequest(const UpdateMessageTextRequest& from);
  UpdateMessageTextRequest(UpdateMessageTextRequest&& from) noexcept
    : UpdateMessageTextRequest() {
    *this = ::std::move(from);
  }

  inline UpdateMessageTextRequest& operator=(const UpdateMessageTextRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline UpdateMessageTextRequest& operator=(UpdateMessageTextRequest&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const UpdateMessageTextRequest& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const UpdateMessageTextRequest* internal_default_instance() {
    return reinterpret_cast<const UpdateMessageTextRequest*>(
               &_UpdateMessageTextRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    8;

  friend void swap(UpdateMessageTextRequest& a, UpdateMessageTextRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(UpdateMessageTextRequest* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(UpdateMessageTextRequest* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline UpdateMessageTextRequest* New() const final {
    return CreateMaybeMessage<UpdateMessageTextRequest>(nullptr);
  }

  UpdateMessageTextRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<UpdateMessageTextRequest>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const UpdateMessageTextRequest& from);
  void MergeFrom(const UpdateMessageTextRequest& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(UpdateMessageTextRequest* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "protocol.chat.v1.UpdateMessageTextRequest";
  }
  protected:
  explicit UpdateMessageTextRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  void set_new_content(const std::string& value);
  void set_new_content(std::string&& value);
  void set_new_content(const char* value);
  void set_new_content(const char* value, size_t size);
  std::string* mutable_new_content();
  std::string* release_new_content();
  void set_allocated_new_content(std::string* new_content);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_new_content();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_new_content(
      std::string* new_content);
  private:
  const std::string& _internal_new_content() const;
  void _internal_set_new_content(const std::string& value);
  ...
  // @@protoc_insertion_point(class_scope:protocol.chat.v1.UpdateMessageTextRequest)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr new_content_;
  ::PROTOBUF_NAMESPACE_ID::uint64 guild_id_;
  ::PROTOBUF_NAMESPACE_ID::uint64 channel_id_;
  ::PROTOBUF_NAMESPACE_ID::uint64 message_id_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
// uint64 message_id = 3;
inline void GetChannelMessagesRequest::clear_message_id() {
  message_id_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 GetChannelMessagesRequest::_internal_message_id() const {
  return message_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 GetChannelMessagesRequest::message_id() const {
  // @@protoc_insertion_point(field_get:protocol.chat.v1.GetChannelMessagesRequest.message_id)
  return _internal_message_id();
}
inline void GetChannelMessagesRequest::_internal_set_message_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  message_id_ = value;
}
inline void GetChannelMessagesRequest::set_message_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_message_id(value);
  // @@protoc_insertion_point(field_set:protocol.chat.v1.GetChannelMessagesRequest.message_id)
}

// .protocol.chat.v1.GetChannelMessagesRequest.Direction direction = 4;
inline void GetChannelMessagesRequest::clear_direction() {
  direction_ = 0;
}
inline ::protocol::chat::v1::GetChannelMessagesRequest_Direction GetChannelMessagesRequest::_internal_direction() const {
  return static_cast< ::protocol::chat::v1::GetChannelMessagesRequest_Direction >(direction_);
}
inline ::protocol::chat::v1::GetChannelMessagesRequest_Direction GetChannelMessagesRequest::direction() const {
  // @@protoc_insertion_point(field_get:protocol.chat.v1.GetChannelMessagesRequest.direction)
  return _internal_direction();
}
inline void GetChannelMessagesRequest::_internal_set_direction(::protocol::chat::v1::GetChannelMessagesRequest_Direction value) {
  
  direction_ = value;
}
inline void GetChannelMessagesRequest::set_direction(::protocol::chat::v1::GetChannelMessagesRequest_Direction value) {
  _internal_set_direction(value);
  // @@protoc_insertion_point(field_set:protocol.chat.v1.GetChannelMessagesRequest.direction)
}

// uint32 count = 5;
inline void GetChannelMessagesRequest::clear_count() {
  count_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetChannelMessagesRequest::_internal_count() const {
  return count_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetChannelMessagesRequest::count() const {
  // @@protoc_insertion_point(field_get:protocol.chat.v1.GetChannelMessagesRequest.count)
  return _internal_count();
}
inline void GetChannelMessagesRequest::_internal_set_count(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  count_ = value;
}
inline void GetChannelMessagesRequest::set_count(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_count(value);
  // @@protoc_insertion_point(field_set:protocol.chat.v1.GetChannelMessagesRequest.count)
}
...
// .protocol.harmonytypes.v1.Content content = 3;
inline bool SendMessageRequest::_internal_has_content() const {
  return this != internal_default_instance() && content_ != nullptr;
}
inline bool SendMessageRequest::has_content() const {
  return _internal_has_content();
}
inline const ::protocol::harmonytypes::v1::Content& SendMessageRequest::_internal_content() const {
...
inline const ::protocol::harmonytypes::v1::Content& SendMessageRequest::content() const {
...
inline ::protocol::harmonytypes::v1::Content* SendMessageRequest::release_content() {
...
inline ::protocol::harmonytypes::v1::Content* SendMessageRequest::unsafe_arena_release_content() {
...
inline ::protocol::harmonytypes::v1::Content* SendMessageRequest::_internal_mutable_content() {
...
inline ::protocol::harmonytypes::v1::Content* SendMessageRequest::mutable_content() {
  // @@protoc_insertion_point(field_mutable:protocol.chat.v1.SendMessageRequest.content)
  return _internal_mutable_content();
}
inline void SendMessageRequest::set_allocated_content(::protocol::harmonytypes::v1::Content* content) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(content_);
  }
...
// uint64 guild_id = 1;
inline void UpdateMessageTextRequest::clear_guild_id() {
  guild_id_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 UpdateMessageTextRequest::_internal_guild_id() const {
  return guild_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 UpdateMessageTextRequest::guild_id() const {
  // @@protoc_insertion_point(field_get:protocol.chat.v1.UpdateMessageTextRequest.guild_id)
  return _internal_guild_id();
}
inline void UpdateMessageTextRequest::_internal_set_guild_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  guild_id_ = value;
}
inline void UpdateMessageTextRequest::set_guild_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_guild_id(value);
  // @@protoc_insertion_point(field_set:protocol.chat.v1.UpdateMessageTextRequest.guild_id)
}

// uint64 channel_id = 2;
inline void UpdateMessageTextRequest::clear_channel_id() {
  channel_id_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 UpdateMessageTextRequest::_internal_channel_id() const {
  return channel_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 UpdateMessageTextRequest::channel_id() const {
  // @@protoc_insertion_point(field_get:protocol.chat.v1.UpdateMessageTextRequest.channel_id)
  return _internal_channel_id();
}
inline void UpdateMessageTextRequest::_internal_set_channel_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  channel_id_ = value;
}
inline void UpdateMessageTextRequest::set_channel_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_channel_id(value);
  // @@protoc_insertion_point(field_set:protocol.chat.v1.UpdateMessageTextRequest.channel_id)
}

// uint64 message_id = 3;
inline void UpdateMessageTextRequest::clear_message_id() {
  message_id_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 UpdateMessageTextRequest::_internal_message_id() const {
  return message_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 UpdateMessageTextRequest::message_id() const {
  // @@protoc_insertion_point(field_get:protocol.chat.v1.UpdateMessageTextRequest.message_id)
  return _internal_message_id();
}
inline void UpdateMessageTextRequest::_internal_set_message_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  message_id_ = value;
}
inline void UpdateMessageTextRequest::set_message_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_message_id(value);
  // @@protoc_insertion_point(field_set:protocol.chat.v1.UpdateMessageTextRequest.message_id)
}

// string new_content = 4;
inline void UpdateMessageTextRequest::clear_new_content() {
  new_content_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& UpdateMessageTextRequest::new_content() const {
  // @@protoc_insertion_point(field_get:protocol.chat.v1.UpdateMessageTextRequest.new_content)
  return _internal_new_content();
}
inline void UpdateMessageTextRequest::set_new_content(const std::string& value) {
  _internal_set_new_content(value);
  // @@protoc_insertion_point(field_set:protocol.chat.v1.UpdateMessageTextRequest.new_content)
}
inline std::string* UpdateMessageTextRequest::mutable_new_content() {
  // @@protoc_insertion_point(field_mutable:protocol.chat.v1.UpdateMessageTextRequest.new_content)
  return _internal_mutable_new_content();
}
inline const std::string& UpdateMessageTextRequest::_internal_new_content() const {
  return new_content_.Get();
}
inline void UpdateMessageTextRequest::_internal_set_new_content(const std::string& value) {
  
  new_content_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void UpdateMessageTextRequest::set_new_content(std::string&& value) {
  
  new_content_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:protocol.chat.v1.UpdateMessageTextRequest.new_content)
}
inline void UpdateMessageTextRequest::set_new_content(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  new_content_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:protocol.chat.v1.UpdateMessageTextRequest.new_content)
}
inline void UpdateMessageTextRequest::set_new_content(const char* value,
    size_t size) {
  
  new_content_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:protocol.chat.v1.UpdateMessageTextRequest.new_content)
}
inline std::string* UpdateMessageTextRequest::_internal_mutable_new_content() {
  
  return new_content_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* UpdateMessageTextRequest::release_new_content() {
  // @@protoc_insertion_point(field_release:protocol.chat.v1.UpdateMessageTextRequest.new_content)
  return new_content_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void UpdateMessageTextRequest::set_allocated_new_content(std::string* new_content) {
  if (new_content != nullptr) {
    
  } else {
    
  }
  new_content_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), new_content,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:protocol.chat.v1.UpdateMessageTextRequest.new_content)
}
inline std::string* UpdateMessageTextRequest::unsafe_arena_release_new_content() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protocol.chat.v1.UpdateMessageTextRequest.new_content)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return new_content_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void UpdateMessageTextRequest::unsafe_arena_set_allocated_new_content(
    std::string* new_content) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (new_content != nullptr) {
  ...
  new_content_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      new_content, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protocol.chat.v1.UpdateMessageTextRequest.new_content)
}
...
template <> struct is_proto_enum< ::protocol::chat::v1::GetChannelMessagesRequest_Direction> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::protocol::chat::v1::GetChannelMessagesRequest_Direction>() {
  return ::protocol::chat::v1::GetChannelMessagesRequest_Direction_descriptor();
}
