...
extern PROTOBUF_INTERNAL_EXPORT_chat_2fv1_2fprofile_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetUserResponse_chat_2fv1_2fprofile_2eproto;
namespace protocol {
namespace chat {
namespace v1 {
...
class GetUserBulkRequestDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetUserBulkRequest> _instance;
} _GetUserBulkRequest_default_instance_;
class GetUserBulkResponseDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetUserBulkResponse> _instance;
} _GetUserBulkResponse_default_instance_;
...
static void InitDefaultsscc_info_GetUserBulkRequest_chat_2fv1_2fprofile_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::protocol::chat::v1::_GetUserBulkRequest_default_instance_;
    new (ptr) ::protocol::chat::v1::GetUserBulkRequest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::protocol::chat::v1::GetUserBulkRequest::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetUserBulkRequest_chat_2fv1_2fprofile_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetUserBulkRequest_chat_2fv1_2fprofile_2eproto}, {}};

static void InitDefaultsscc_info_GetUserBulkResponse_chat_2fv1_2fprofile_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::protocol::chat::v1::_GetUserBulkResponse_default_instance_;
    new (ptr) ::protocol::chat::v1::GetUserBulkResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::protocol::chat::v1::GetUserBulkResponse::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_GetUserBulkResponse_chat_2fv1_2fprofile_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_GetUserBulkResponse_chat_2fv1_2fprofile_2eproto}, {
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_chat_2fv1_2fprofile_2eproto[7];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_chat_2fv1_2fprofile_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::protocol::chat::v1::GetUserBulkRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::protocol::chat::v1::GetUserBulkRequest, user_ids_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::protocol::chat::v1::GetUserBulkResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::protocol::chat::v1::GetUserBulkResponse, users_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 15, -1, sizeof(::protocol::chat::v1::GetUserBulkRequest)},
  { 21, -1, sizeof(::protocol::chat::v1::GetUserBulkResponse)},
  { 27, -1, sizeof(::protocol::chat::v1::GetUserMetadataRequest)},
  { 33, -1, sizeof(::protocol::chat::v1::GetUserMetadataResponse)},
  { 39, -1, sizeof(::protocol::chat::v1::ProfileUpdateRequest)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::protocol::chat::v1::_GetUserBulkRequest_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::protocol::chat::v1::_GetUserBulkResponse_default_instance_),
...
const char descriptor_table_protodef_chat_2fv1_2fprofile_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "rRequest\022\017\n\007user_id\030\001 \001(\004\"\204\001\n\017GetUserRes"
  "ponse\022\021\n\tuser_name\030\001 \001(\t\022\023\n\013user_avatar\030"
  "\002 \001(\t\0229\n\013user_status\030\003 \001(\0162$.protocol.ha"
  "rmonytypes.v1.UserStatus\022\016\n\006is_bot\030\004 \001(\010"
  "\"&\n\022GetUserBulkRequest\022\020\n\010user_ids\030\001 \003(\004"
  "\"G\n\023GetUserBulkResponse\0220\n\005users\030\001 \003(\0132!"
  ".protocol.chat.v1.GetUserResponse\"(\n\026Get"
  "UserMetadataRequest\022\016\n\006app_id\030\001 \001(\t\"+\n\027G"
  "etUserMetadataResponse\022\020\n\010metadata\030\001 \001(\t"
  "\"\350\001\n\024ProfileUpdateRequest\022\024\n\014new_usernam"
  "e\030\001 \001(\t\022\027\n\017update_username\030\002 \001(\010\022\022\n\nnew_"
  "avatar\030\003 \001(\t\022\025\n\rupdate_avatar\030\004 \001(\010\0228\n\nn"
  "ew_status\030\005 \001(\0162$.protocol.harmonytypes."
  "v1.UserStatus\022\025\n\rupdate_status\030\006 \001(\010\022\016\n\006"
  "is_bot\030\007 \001(\010\022\025\n\rupdate_is_bot\030\010 \001(\010B3Z1g"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_chat_2fv1_2fprofile_2eproto_sccs[7] = {
  &scc_info_GetUserBulkRequest_chat_2fv1_2fprofile_2eproto.base,
  &scc_info_GetUserBulkResponse_chat_2fv1_2fprofile_2eproto.base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_chat_2fv1_2fprofile_2eproto = {
  false, false, descriptor_table_protodef_chat_2fv1_2fprofile_2eproto, "chat/v1/profile.proto", 736,
  &descriptor_table_chat_2fv1_2fprofile_2eproto_once, descriptor_table_chat_2fv1_2fprofile_2eproto_sccs, descriptor_table_chat_2fv1_2fprofile_2eproto_deps, 7, 1,
  schemas, file_default_instances, TableStruct_chat_2fv1_2fprofile_2eproto::offsets,
  file_level_metadata_chat_2fv1_2fprofile_2eproto, 7, file_level_enum_descriptors_chat_2fv1_2fprofile_2eproto, file_level_service_descriptors_chat_2fv1_2fprofile_2eproto,
};
...
void GetUserBulkRequest::InitAsDefaultInstance() {
}
class GetUserBulkRequest::_Internal {
 public:
};

GetUserBulkRequest::GetUserBulkRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena),
  user_ids_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:protocol.chat.v1.GetUserBulkRequest)
}
GetUserBulkRequest::GetUserBulkRequest(const GetUserBulkRequest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      user_ids_(from.user_ids_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:protocol.chat.v1.GetUserBulkRequest)
}

void GetUserBulkRequest::SharedCtor() {
}

GetUserBulkRequest::~GetUserBulkRequest() {
  // @@protoc_insertion_point(destructor:protocol.chat.v1.GetUserBulkRequest)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void GetUserBulkRequest::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
}

void GetUserBulkRequest::ArenaDtor(void* object) {
  GetUserBulkRequest* _this = reinterpret_cast< GetUserBulkRequest* >(object);
  (void)_this;
}
void GetUserBulkRequest::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void GetUserBulkRequest::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetUserBulkRequest& GetUserBulkRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetUserBulkRequest_chat_2fv1_2fprofile_2eproto.base);
  return *internal_default_instance();
}


void GetUserBulkRequest::Clear() {
// @@protoc_insertion_point(message_clear_start:protocol.chat.v1.GetUserBulkRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetUserBulkRequest::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedUInt64Parser(_internal_mutable_user_ids(), ptr, ctx);
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* GetUserBulkRequest::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:protocol.chat.v1.GetUserBulkRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:protocol.chat.v1.GetUserBulkRequest)
  return target;
}

size_t GetUserBulkRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:protocol.chat.v1.GetUserBulkRequest)
  size_t total_size = 0;
...
void GetUserBulkRequest::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:protocol.chat.v1.GetUserBulkRequest)
  GOOGLE_DCHECK_NE(&from, this);
  const GetUserBulkRequest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetUserBulkRequest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:protocol.chat.v1.GetUserBulkRequest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:protocol.chat.v1.GetUserBulkRequest)
    MergeFrom(*source);
  }
}

void GetUserBulkRequest::MergeFrom(const GetUserBulkRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:protocol.chat.v1.GetUserBulkRequest)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetUserBulkRequest::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:protocol.chat.v1.GetUserBulkRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetUserBulkRequest::CopyFrom(const GetUserBulkRequest& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:protocol.chat.v1.GetUserBulkRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetUserBulkRequest::IsInitialized() const {
  return true;
}

void GetUserBulkRequest::InternalSwap(GetUserBulkRequest* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  user_ids_.InternalSwap(&other->user_ids_);
}

::PROTOBUF_NAMESPACE_ID::Metadata GetUserBulkRequest::GetMetadata() const {
  return GetMetadataStatic();
}
...
void GetUserBulkResponse::InitAsDefaultInstance() {
}
class GetUserBulkResponse::_Internal {
 public:
};

GetUserBulkResponse::GetUserBulkResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena),
  users_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:protocol.chat.v1.GetUserBulkResponse)
}
GetUserBulkResponse::GetUserBulkResponse(const GetUserBulkResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      users_(from.users_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:protocol.chat.v1.GetUserBulkResponse)
}

void GetUserBulkResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetUserBulkResponse_chat_2fv1_2fprofile_2eproto.base);
}

GetUserBulkResponse::~GetUserBulkResponse() {
  // @@protoc_insertion_point(destructor:protocol.chat.v1.GetUserBulkResponse)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void GetUserBulkResponse::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
}

void GetUserBulkResponse::ArenaDtor(void* object) {
  GetUserBulkResponse* _this = reinterpret_cast< GetUserBulkResponse* >(object);
  (void)_this;
}
void GetUserBulkResponse::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void GetUserBulkResponse::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetUserBulkResponse& GetUserBulkResponse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetUserBulkResponse_chat_2fv1_2fprofile_2eproto.base);
  return *internal_default_instance();
}


void GetUserBulkResponse::Clear() {
// @@protoc_insertion_point(message_clear_start:protocol.chat.v1.GetUserBulkResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetUserBulkResponse::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    CHK_(ptr);
    switch (tag >> 3) {
      // repeated .protocol.chat.v1.GetUserResponse users = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr -= 1;
          do {
...
::PROTOBUF_NAMESPACE_ID::uint8* GetUserBulkResponse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:protocol.chat.v1.GetUserBulkResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:protocol.chat.v1.GetUserBulkResponse)
  return target;
}

size_t GetUserBulkResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:protocol.chat.v1.GetUserBulkResponse)
  size_t total_size = 0;
...
void GetUserBulkResponse::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:protocol.chat.v1.GetUserBulkResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const GetUserBulkResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetUserBulkResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:protocol.chat.v1.GetUserBulkResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:protocol.chat.v1.GetUserBulkResponse)
    MergeFrom(*source);
  }
}

void GetUserBulkResponse::MergeFrom(const GetUserBulkResponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:protocol.chat.v1.GetUserBulkResponse)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetUserBulkResponse::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:protocol.chat.v1.GetUserBulkResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetUserBulkResponse::CopyFrom(const GetUserBulkResponse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:protocol.chat.v1.GetUserBulkResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetUserBulkResponse::IsInitialized() const {
  return true;
}

void GetUserBulkResponse::InternalSwap(GetUserBulkResponse* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  users_.InternalSwap(&other->users_);
}

::PROTOBUF_NAMESPACE_ID::Metadata GetUserBulkResponse::GetMetadata() const {
  return GetMetadataStatic();
}
...
template<> PROTOBUF_NOINLINE ::protocol::chat::v1::GetUserBulkRequest* Arena::CreateMaybeMessage< ::protocol::chat::v1::GetUserBulkRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::protocol::chat::v1::GetUserBulkRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::protocol::chat::v1::GetUserBulkResponse* Arena::CreateMaybeMessage< ::protocol::chat::v1::GetUserBulkResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::protocol::chat::v1::GetUserBulkResponse >(arena);
}
