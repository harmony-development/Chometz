StaticLibrary {
	...
	Export {
		...
		cpp.includePaths: [exportingProduct.buildDirectory, exportingProduct.sourceDirectory, exportingProduct.sourceDirectory+"/protobuf/src", exportingProduct.sourceDirectory+"/protobuf/src/google/protobuf"]
	}
