StaticLibrary {
	...
	Export {
		...
		cpp.includePaths: [product.buildDirectory, product.sourceDirectory, product.sourceDirectory+"/protobuf/src", product.sourceDirectory+"/protobuf/src/google/protobuf"]
	}
